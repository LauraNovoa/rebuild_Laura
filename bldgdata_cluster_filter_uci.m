...
function [cluster_data,output_winter_wkdy,output_winter_wknd,output_summer_wkdy,output_summer_wknd]=bldgdata_cluster_filter_uci(filenameholder,summer_days,summer_weekend_start,winter_days,winter_weekend_start)

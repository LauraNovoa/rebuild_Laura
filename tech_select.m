...
utility_exists=1;
%% DG
%%% DG Vector [%%% Capital Cost ($/kW);%1
%%% O&M ($/kWh);%2
%%% Capacity Increment (kW);%3 % Capacity 1 MW -> 1 MWh/4 (15 min)  
...
ees_v1=[500; 0.001; 0.001; 0.1; 1; 0.25; 0.25; .95; .95; .995];
